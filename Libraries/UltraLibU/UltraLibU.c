...
The code was written in a Metrowerksª environment and is compatible with
...
The timings below are average values for a standard Macintosh Quadra 800ª
and a PowerMac 9500/120ª.  The compiler was Metrowerks CW8ª with full
